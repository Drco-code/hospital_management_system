...
class Appointment(models.Model):
    ...
    patient = models.ForeignKey(Patient, verbose_name=_("Patient"), related_name="appointment",on_delete=models.CASCADE)
    doctor = models.ForeignKey(Doctor, verbose_name=_("Doctor"),related_name='appointment', on_delete=models.CASCADE)
